      ...
      <View style={styles.container}>
        ...
        <View style={{ flex: 7 }}>
          <ScrollView>
            ...
            <FriendPhoto name="Wedding Party" caption="Food Hunting" read />
            <FriendPhoto name="Interview" caption="Night Out" read={false} />
            <FriendPhoto name="Date Night" caption="Food Hunting" read />
            <FriendPhoto name="Graduation Party" caption="Night Out" read={false} />
            <FriendPhoto name="Singing Competition" caption="Food Hunting" read />
            <FriendPhoto name="Girl's Night Out" caption="Night Out" read={false} />
            <FriendPhoto name="Hackathon" caption="Food Hunting" read />
            <FriendPhoto name="Interview" caption="Food Hunting" read />
            <FriendPhoto name="Date Night" caption="Night Out" read={false} />
            <FriendPhoto name="Job Interview" caption="Food Hunting" read />
            <FriendPhoto name="Alumni Dinner" caption="Night Out" read={false} />
            <FriendPhoto name="NW Hacks 2019" caption="Food Hunting" read />
          </ScrollView>
        </View>
      </View>
    );
